    ...
    var e,
        ...
        s = {
                ...
                i &&
                    (async () => {
                        ...
                        let u = document.getElementById("draggable"),
                            ...
                            I = (D.clone().add(1, "day").format("YYYY-MM-DD"), D.format("YYYY-MM")),
                            M = null,
                            N = new e(i, {
                                ...
                                dayMaxEvents: !0,
                                events: [
                                    { id: d.setID(), title: "Interview", start: I + "05T10:30:00", end: I + "05T13:30:00", className: "bg-info", location: "Room 127", description: "Lorem ipsum dolor sit amet, consectetur adipiscing elit" },
                                    {
                                        id: d.setID(),
                                    ...
                                    { id: d.setID(), title: "Meeting", start: S + "T10:30:00", end: S + "T11:30:00", className: "bg-success", location: "Office", description: "Nunc quis augue non odio porttitor mattis" },
                                    {
                                        id: d.setID(),
                                        title: "Lunch",
                                        start: S + "T12:00:00",
                        ...
                        let j = (e) => {
                            (O = e.event),
                                ...
                                O.extendedProps.location && (w.value = O.extendedProps.location),
                                O.extendedProps.description && (E.value = O.extendedProps.description),
                    ...
                    (async () => {
                        ...
                        let u = c().startOf("day"),
                            ...
                            m = new e(o, {
                                ...
                                droppable: !0,
                                events: [
                                    { id: d.setID(), title: "Interview", start: f + "05T10:30:00", end: f + "05T13:30:00", className: "bg-info", location: "Room 127", description: "Lorem ipsum dolor sit amet, consectetur adipiscing elit" },
                                    {
                                        id: d.setID(),
                                        title: "Team building trip",
                                        start: f + "15",
                                    ...
                                    { id: d.setID(), title: "Meeting", start: h + "T10:30:00", end: h + "T11:30:00", className: "bg-success", location: "Office", description: "Nunc quis augue non odio porttitor mattis" },
                                    {
                                        id: d.setID(),
                                        title: "Lunch",
                                        start: h + "T12:00:00",
            ...
            2040: (e, t, n) => {
                ...
                i.length &&
                    Promise.all([n.e(399).then(n.bind(n, 5286)), n.e(191).then(n.bind(n, 1042)), n.e(341).then(n.bind(n, 9622)), n.e(248).then(n.bind(n, 5010)), n.e(482).then(n.bind(n, 2756)), n.e(7).then(n.bind(n, 6167))])
        ...
        (() => {
            ...
            function B(e, t, n) {
                ...
                var i = e.getBoundingClientRect(),
                    s = 1,
                    o = 1;
                t && D(e) && ((s = (e.offsetWidth > 0 && j(i.width) / e.offsetWidth) || 1), (o = (e.offsetHeight > 0 && j(i.height) / e.offsetHeight) || 1));
                ...
                return n && ("html" === C(n) || ("body" === C(n) && "static" === H(n).position))
                    ...
                    : n ||
                          (function (e) {
                              ...
                              if (/Trident/i.test(P()) && D(e) && "fixed" === H(e).position) return null;
                              var n = W(e);
                              for (S(n) && (n = n.host); D(n) && ["html", "body"].indexOf(C(n)) < 0; ) {
                                  var i = H(n);
                                  if (
                                      "none" !== i.transform ||
                                      "none" !== i.perspective ||
                ...
                fn: function (e) {
                    ...
                    if (d && u) {
                        var m = (function (e, t) {
                            ...
                            x = U(k, C, T),
                            O = p;
                        r.modifiersData[l] = (((o = {})[O] = x), (o.centerOffset = x - C), o);
                    }
                },
                effect: function (e) {
                    var t = e.state,
            ...
            function ee(e) {
                ...
                if (f) {
                    var O = V(r),
                        D = "clientHeight",
                        S = "clientWidth";
                    if ((O === x(r) && "static" !== H((O = F(r))).position && "absolute" === h && ((D = "scrollHeight"), (S = "scrollWidth")), l === t || ((l === s || l === i) && d === c)))
                        (T = n), (y -= (g && O === C && C.visualViewport ? C.visualViewport.height : O[D]) - a.height), (y *= p ? 1 : -1);
                    if (l === s || ((l === t || l === n) && d === c)) (k = i), (_ -= (g && O === C && C.visualViewport ? C.visualViewport.width : O[S]) - a.width), (_ *= p ? 1 : -1);
                }
                var L,
                ...
                return (
                    ...
                    (y = M.y),
                    p
                        ? Object.assign({}, I, (((L = {})[T] = A ? "0" : ""), (L[k] = E ? "0" : ""), (L.transform = (C.devicePixelRatio || 1) <= 1 ? "translate(" + _ + "px, " + y + "px)" : "translate3d(" + _ + "px, " + y + "px, 0)"), L))
            ...
            function ue(e) {
                return ["html", "body", "#document"].indexOf(C(e)) >= 0 ? e.ownerDocument.body : D(e) && de(e) ? e : ue(W(e));
            }
            function he(e, t) {
                var n;
                void 0 === t && (t = []);
            ...
            function me(e, t, n, i) {
                var s =
                        "clippingParents" === t
                            ? (function (e) {
                                  var t = he(W(e)),
                                      n = ["absolute", "fixed"].indexOf(H(e).position) >= 0 && D(e) ? V(e) : e;
                                  return O(n)
                                      ? t.filter(function (e) {
                    ...
                    if (x) {
                        if (d) {
                            var q,
                                ...
                                ne = ee[$],
                                ie = U(0, O[H], G[H]),
                                se = k ? O[H] / 2 - R - ie - te - L.mainAxis : J - ie - te - L.mainAxis,
                                oe = k ? -O[H] / 2 + R + ie + ne + L.mainAxis : K + ie + ne + L.mainAxis,
            ...
            function Te(e, t, n) {
                ...
                return (
                    (o || (!o && !n)) &&
                        (("body" !== C(t) || de(a)) && (c = (i = t) !== x(i) && D(i) ? { scrollLeft: (s = i).scrollLeft, scrollTop: s.scrollTop } : le(i)),
                        D(t) ? (((d = B(t, !0)).x += t.clientLeft), (d.y += t.clientTop)) : a && (d.x = ce(a))),
                    ...
                    var s,
                        ...
                        d = {
                            ...
                            setOptions: function (n) {
                                ...
                                u(), (a.options = Object.assign({}, o, a.options, s)), (a.scrollParents = { reference: O(e) ? he(e) : e.contextElement ? he(e.contextElement) : [], popper: he(t) });
                                var r = (function (e) {
                                    var t = Ce(e);
                    ...
                    h = o
                        ? (function (e, t, n) {
                              return function i(s) {
                                  ...
                                  for (let { target: r } = s; r && r !== this; r = r.parentNode) for (const a of o) if (a === r) return ft(s, { delegateTarget: r }), i.oneOff && pt.off(e, s.type, t, n), n.apply(r, [s]);
                              };
                          })(e, n, r)
                        : (function (e, t) {
                              return function n(i) {
            ...
            const Ct = {
                ...
                Dt = { endCallback: "(function|null)", leftCallback: "(function|null)", rightCallback: "(function|null)" };
            class St extends yt {
                constructor(e, t) {
            ...
            const Qt = "dropdown",
                ...
                fn = { autoClose: "(boolean|string)", boundary: "(string|element)", display: "string", offset: "(array|string|function)", popperConfig: "(null|object|function)", reference: "(string|element|object)" };
            class mn extends wt {
                constructor(e, t) {
                    super(e, t),
                        (this._popper = null),
                        (this._parent = this._element.parentNode),
                        (this._menu = Ct.next(this._element, rn)[0] || Ct.prev(this._element, rn)[0] || Ct.findOne(rn, this._parent)),
                ...
                show() {
                    ...
                    if (!pt.trigger(this._element, "show.bs.dropdown", e).defaultPrevented) {
                        if ((this._createPopper(), "ontouchstart" in document.documentElement && !this._parent.closest(".navbar-nav"))) for (const e of [].concat(...document.body.children)) pt.on(e, "mouseover", Fe);
                ...
                static dataApiKeydownHandler(e) {
                    ...
                    if (t && !n) return;
                    e.preventDefault();
                    const s = this.matches(sn) ? this : Ct.prev(this, sn)[0] || Ct.next(this, sn)[0] || Ct.findOne(sn, e.delegateTarget.parentNode),
            ...
            class Ln extends yt {
                ...
                _handleFocusin(e) {
                    ...
                    0 === n.length ? t.focus() : this._lastTabNavDirection === On ? n[n.length - 1].focus() : n[0].focus();
                }
                _handleKeydown(e) {
            ...
            class $n extends wt {
                ...
                hide() {
                    ...
                    pt.trigger(this._element, "hide.bs.modal").defaultPrevented ||
                        ((this._isShown = !1), (this._isTransitioning = !0), this._focustrap.deactivate(), this._element.classList.remove(Pn), this._queueCallback(() => this._hideModal(), this._element, this._isAnimated()));
                }
                dispose() {
            ...
            class mi extends wt {
                ...
                _getTemplateFactory(e) {
                    return (
                        this._templateFactory ? this._templateFactory.changeContent(e) : (this._templateFactory = new si({ ...this._config, content: e, extraClass: this._resolvePossibleFunction(this._config.customClass) })),
            ...
            class ki extends wt {
                ...
                _process(e) {
                    this._activeTarget !== e &&
                        (this._clearActiveClass(this._config.target), (this._activeTarget = e), e.classList.add(yi), this._activateParents(e), pt.trigger(this._element, "activate.bs.scrollspy", { relatedTarget: e }));
                }
                _activateParents(e) {
            ...
            class Ni extends wt {
                ...
                _activate(e, t) {
                    ...
                    this._queueCallback(
                        () => {
                            "tab" === e.getAttribute("role") ? (e.removeAttribute("tabindex"), e.setAttribute("aria-selected", !0), this._toggleDropDown(e, !0), pt.trigger(e, "shown.bs.tab", { relatedTarget: t })) : e.classList.add(Li);
                        },
                        e,
                ...
                _keydown(e) {
                    ...
                    n && (n.focus({ preventScroll: !0 }), Ni.getOrCreateInstance(n).show());
                }
                _getChildren() {
                ...
                _toggleDropDown(e, t) {
                    ...
                    i(".dropdown-toggle", Di), i(".dropdown-menu", Li), n.setAttribute("aria-expanded", t);
                }
